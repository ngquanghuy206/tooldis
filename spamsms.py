...
# apiby @trungduy1404 (tôn trọng tý thì đừng xoá)
# facebook.com/trungduycutodz
...
if phone == "0868371079":
    print(f"{vua}Spam số admin à tho lol")
    exit()
delay = float(input(f"{vua}Nhập Delay Giữa Các Tin Nhắn (trên 3): {vang}"))
